  ...
  <div class="max-h-screen overflow-y-auto overflow-x-hidden" ref="palette">
    <section class="container mx-auto px-1 md:px-0 transition-all duration-300">
      <div class="grid grid-cols-1 md:grid-cols-2 mx-2">
        <svg
          class="min-w-full animate__animated animate__backInDown mt-0 md:mt-10 lg:mt-0 transition-all duration-300"
          version="1.0"
...
-125 10 0 37 50 91 95 103 33 8 39 7 82 -12z"
        ...
        <div>
          <select
            class="select select-bordered w-full mt-5 bg-base-100 animate__animated animate__backInDown"
            @click="loadDevices"
            v-model="device"
            @change="changeDevice"
          ...
          <select
            class="select select-bordered w-full mt-5 animate__animated animate__backInDown"
            v-model="theme"
            @change="changeTheme"
          >
      ...
      <div
        class="pb-3 text-right mr-2 animate__animated animate__backInUp sticky -top-2 z-50 bg-base-100"
      >
        <button
          class="btn btn-square flex-shrink tooltip tooltip-bottom"
          @click="lastPage"
      ...
      <div
        :class="`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-6 mt-5 transition-all duration-300 ${
          !haveAudio ? 'mb-20' : ''
        }`"
      >
        <Button
